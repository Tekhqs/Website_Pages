...
}(function(){(function(){(function(n){var c=1.5;
var d=0.4;
var g="#000";
...
var F="transparent";
var H="#fff";
var r=function(){return{icon:{border:{width:1}},label:{font:A,padding:3},line:{length:10,width:2},visible:true};
};
var b=function(){return{labels:{font:A},notes:r(),title:{font:B,margin:5}};
};
...
var q=function(){return{width:2};
};
var s=function(){return{gap:1,highlight:{line:{opacity:1,width:3}},line:{width:1},spacing:0.3};
};
var u=function(){return{line:{opacity:1,width:0},markers:{size:6,visible:false},opacity:0.5};
};
var v=function(){return{markers:{visible:false},width:2};
};
...
var t=function(){return{labels:{background:"",color:"",padding:{top:5,bottom:5,left:7,right:7}}};
};
var o=function(){return{labels:{background:"",color:"",padding:{top:5,bottom:5,left:7,right:7}}};
};
var D=function(I){return{visible:true,labels:{font:z},overlay:I.gradients?{}:{gradient:"none"},area:a(),bar:e(),boxPlot:h(),bubble:i(),bullet:j(),candlestick:k(),column:l(),pie:t(),donut:m(),funnel:o(),horizontalWaterfall:G(),line:q(),verticalLine:q(),notes:r(),ohlc:s(),radarArea:u(),radarLine:v(),polarArea:u(),polarLine:v(),rangeBar:w(),rangeColumn:x(),scatterLine:C(),verticalArea:a(),verticalBullet:j(),waterfall:G()};
};
var E=function(){return{font:B};
};
var p=function(){return{labels:{font:A}};
};
var f=function(I){if(I===void 0){I={};
}return{axisDefaults:b(),categoryAxis:{majorGridLines:{visible:true}},navigator:{pane:{height:90,margin:{top:10}}},seriesDefaults:D(I),title:E(),legend:p()};
};
kendo.deepExtend(n,{chartBaseTheme:f});
...
(function(){var x="#656565";
var r="rgba( 255, 255, 255, .5 )";
var s="#bdbdbd";
var o="rgba(0, 0, 0, .04)";
var p="rgba(0, 0, 0, .08)";
var v=["#ff6358","#ffd246","#78d237","#28b4c8","#2d73f5","#aa46be"];
var w=["#ffd9dc","#ffeced","#cceef3","#e6f8fb","#fff2da","#fff7e8"];
var u=v[0];
var q=n;
function t(){return{icon:{background:"#007cc0",border:{color:"#007cc0"}},label:{color:"#ffffff"},line:{color:o}};
}i("default-v2",{chart:{title:{color:x},legend:{labels:{color:x},inactiveItems:{labels:{color:r},markers:{color:r}}},seriesDefaults:{labels:{color:x},errorBars:{color:x},notes:t(),candlestick:{downColor:o,line:{color:s}},area:{opacity:0.8},waterfall:{line:{color:o}},horizontalWaterfall:{line:{color:o}},overlay:{gradient:"none"},border:{_brightness:1}},seriesColors:v,axisDefaults:{line:{color:o},labels:{color:x},minorGridLines:{color:p},majorGridLines:{color:o},title:{color:x},crosshair:{color:x},notes:t()}},gauge:{pointer:{color:u},scale:{rangePlaceholderColor:o,labels:{color:x},minorTicks:{color:x},majorTicks:{color:x},line:{color:x}}},diagram:{shapeDefaults:{fill:{color:u},connectorDefaults:{fill:{color:x},stroke:{color:q},hover:{fill:{color:q},stroke:{color:x}}},content:{color:x}},editable:{resize:{handles:{fill:{color:q},stroke:{color:s},hover:{fill:{color:s},stroke:{color:s}}}},rotate:{thumb:{stroke:{color:s},fill:{color:s}}}},selectable:{stroke:{color:s}},connectionDefaults:{stroke:{color:s},content:{color:s},selection:{handles:{fill:{color:q},stroke:{color:s}},stroke:{color:s}}}},treeMap:{colors:f(v,w)}});
}());
...
(function(b,a){a("kendo.dataviz.themes",["kendo.dataviz.core","dataviz/themes/chart-base-theme","dataviz/themes/themes"],b);
