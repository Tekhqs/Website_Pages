...
},_adjustListWidth:function(){var Z=this.list,ab=Z[0].style.width,ac=this.options.anchor,X,Y,aa=z._outerWidth;
if(!Z.data("width")&&ab){return;
}X=window.getComputedStyle?window.getComputedStyle(ac[0],null):0;
Y=X?parseFloat(X.width):aa(ac);
...
Z.css({fontFamily:ac.css("font-family"),width:ab}).data("width",ab);
