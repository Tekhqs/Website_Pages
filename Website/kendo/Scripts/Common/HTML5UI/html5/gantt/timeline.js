...
},_adjustHeight:function(){this.content.height(this.element.height()-z(this.header));
},createLayout:function(T){var S=this._headers(T);
var Q=this._colgroup();
var V=this._headerTree;
var R=p("thead",null,S);
var U=p("table",{style:{width:this._tableWidth+"px"}},[Q,R]);
V.render([U]);
...
X.push(Q);
if(R){if(R.destroy!==false){Q.children.push(p("span",{className:V.taskActions},[p("a",{className:V.link+" "+V.taskDelete,href:"#"},[p("span",{className:V.icon+" "+V.iconDelete})])]));
...
S++){Q=W[S];
V=r(Q.text);
U.push(p("th",{colspan:Q.span,className:aa.header+(Q.isNonWorking?" "+aa.nonWorking:"")},[V]));
}Z.push(p("tr",null,U));
}return Z;
