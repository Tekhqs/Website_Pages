...
V.value(V._value);
}},_setOptions:function(S){this.calendar.setOptions({focusOnNav:false,change:S.change,culture:S.culture,dates:S.dates,depth:S.depth,footer:S.footer,format:S.format,max:S.max,min:S.min,month:S.month,weekNumber:S.weekNumber,start:S.start,disableDates:S.disableDates});
