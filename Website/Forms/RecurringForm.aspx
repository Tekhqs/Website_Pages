                ...
                <div class="row">
                    <div class="col-12">
                        <telerik:RadTabStrip RenderMode="Lightweight" runat="server" ID="RadTabStrip1" MultiPageID="RadMultiPage1" SelectedIndex="0">
                            <Tabs>
                                <telerik:RadTab Text="Create New" Width="200px"></telerik:RadTab>
                                <telerik:RadTab Text="Scheduled Payments" Width="200px"></telerik:RadTab>
                            </Tabs>
                        </telerik:RadTabStrip>
                    </div>
                </div>
                        ...
                        It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s 
                                ...
                                <telerik:RadMultiPage runat="server" ID="RadMultiPageCC" SelectedIndex="0" CssClass="outerMultiPage">
                                    <telerik:RadPageView runat="server" ID="RadPageView5">
                                        <telerik:RadTabStrip RenderMode="Lightweight" runat="server" ID="RadTabStrip4" MultiPageID="RadMultiPage4" CssClass="pt-4" SelectedIndex="0">
                                            <Tabs>
                                                        ...
                                                        <div id="newTranNewCardForm" class="card-body editibleCell ddlApp pt-5">
                                                            <div class="form-row">
                                                                <div class="form-group col-md-5">
                                                                    ...
                                                                    <telerik:RadTextBox ID="txtCardNumber" runat="server" CssClass="form-control" TabIndex="1" Width="650px"></telerik:RadTextBox>
                                                                </div>
                                                                <div class="offset-1">
                                                                </div>
                                                                <div class="form-group col-md-5">
                                                                    <label class="ebiz-label">Billing Address *</label>
                                                                    <telerik:RadTextBox ID="txtBillingAddress" runat="server" CssClass="form-control" TabIndex="6" Width="650px"></telerik:RadTextBox>
                                                                </div>
                                                            </div>
                                                            <div class="form-row">
                                                                <div class="form-group col-md-5">
                                                                    <label class="ebiz-label">Name on Card *</label>
                                                                    <telerik:RadTextBox ID="txtCardHolderName" runat="server" CssClass="form-control" TabIndex="2" Width="650px"></telerik:RadTextBox>
                                                                </div>
                                                                <div class="offset-1">
                                                                </div>
                                                            ...
                                                            <div class="form-row">
                                                                ...
                                                                <div class="form-group col-md-4">
                                                                    ...
                                                                    <telerik:RadTextBox ID="txtEmail" runat="server" CssClass="form-control" TabIndex="9" Width="650px"></telerik:RadTextBox>
                                                                </div>
                                                            </div>
                                                            <div class="form-row pt-5">
                                                                <div class="offset-6"></div>
                                                                <div class="col-md-6">
                                                                    <telerik:RadButton ID="btnProcess" runat="server" Text="Create Recurring Payment" TabIndex="11" Width="500px" Height="30px"></telerik:RadButton>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div id="AchForm" class="editibleCell ddlApp pt-5">
                                                            <div class="form-row">
                                                                <div class="form-group col-md-5">
                                                                    ...
                                                                    <telerik:RadTextBox ID="txtNewACHAccountHolderName" runat="server" CssClass="form-control" TabIndex="6" Width="650px"></telerik:RadTextBox>
                                                                </div>
                                                                <div class="offset-1">
                                                                </div>
                                                                ...
                                                                <div class="form-group col-md-5">
                                                                    ...
                                                                    <telerik:RadTextBox ID="txtNewACHBankRoutingNumber" runat="server" CssClass="form-control" TabIndex="6" Width="650px"></telerik:RadTextBox>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-row">
                                                                ...
                                                                <div class="form-group col-md-5">
                                                                    ...
                                                                    <telerik:RadTextBox ID="txtNewACHBankAccountNumber" runat="server" CssClass="form-control" TabIndex="6" Width="650px"></telerik:RadTextBox>
